...
!--------------------------------------------------------------------
      ...
      rate(:,:, 545) = rate(:,:, 545) * inv(:,:, 1)
      rate(:,:, 548) = rate(:,:, 548) * inv(:,:, 1)
      rate(:,:, 551) = rate(:,:, 551) * inv(:,:, 1)
      rate(:,:, 558) = rate(:,:, 558) * inv(:,:, 1)
      rate(:,:, 563) = rate(:,:, 563) * inv(:,:, 1)
      rate(:,:, 604) = rate(:,:, 604) * inv(:,:, 1)
      rate(:,:, 746) = rate(:,:, 746) * inv(:,:, 2)
      rate(:,:, 749) = rate(:,:, 749) * inv(:,:, 2)
      rate(:,:, 183) = rate(:,:, 183) * m(:,:)
      rate(:,:, 184) = rate(:,:, 184) * m(:,:)
      rate(:,:, 186) = rate(:,:, 186) * m(:,:)
      rate(:,:, 187) = rate(:,:, 187) * m(:,:)
