...
!----------------------------------------------
      do k = 1,avec_len
         ...
         mat(k,1595) = (rxt(k,624)+rxt(k,697)+rxt(k,710)+rxt(k,719))*y(k,110)
         mat(k,1697) = (rxt(k,624)+rxt(k,697)+rxt(k,710)+rxt(k,719))*y(k,99)
         mat(k,2440) = rxt(k,290)*y(k,76)
         mat(k,986) = rxt(k,294)*y(k,72)
         mat(k,2250) = rxt(k,294)*y(k,24)
         mat(k,1998) = rxt(k,290)*y(k,23)
         mat(k,1596) = (rxt(k,623)+rxt(k,699)+rxt(k,707)+rxt(k,716))*y(k,111)
         mat(k,1809) = (rxt(k,626)+rxt(k,696)+rxt(k,709)+rxt(k,718))*y(k,110)
         mat(k,1698) = (rxt(k,626)+rxt(k,696)+rxt(k,709)+rxt(k,718))*y(k,103)
         mat(k,1831) = (rxt(k,623)+rxt(k,699)+rxt(k,707)+rxt(k,716))*y(k,99)
...
!----------------------------------------------
      do k = 1,avec_len
         ...
         mat(k,1133) = rxt(k,259)*y(k,72) + (rxt(k,705)+rxt(k,714)+rxt(k,723)) &
                      *y(k,103)
         mat(k,1806) = (rxt(k,705)+rxt(k,714)+rxt(k,723))*y(k,77) + (rxt(k,625) &
                       +rxt(k,695)+rxt(k,706)+rxt(k,715))*y(k,111)
         mat(k,1829) = (rxt(k,625)+rxt(k,695)+rxt(k,706)+rxt(k,715))*y(k,103)
...
!----------------------------------------------
      do k = 1,avec_len
         ...
         mat(k,1597) = -(rxt(k,299)*y(k,164) + rxt(k,300)*y(k,259) + (rxt(k,305) &
                      + rxt(k,306)) * y(k,255) + (rxt(k,623) + rxt(k,699) + rxt(k,707) &
                      + rxt(k,716)) * y(k,111) + (rxt(k,624) + rxt(k,697) + rxt(k,710) &
                      + rxt(k,719)) * y(k,110) + (rxt(k,631) + rxt(k,726) + rxt(k,730) &
                      + rxt(k,734)) * y(k,112))
         mat(k,2486) = -rxt(k,299)*y(k,99)
         mat(k,2178) = -rxt(k,300)*y(k,99)
         mat(k,1874) = -(rxt(k,305) + rxt(k,306)) * y(k,99)
         mat(k,1833) = -(rxt(k,623) + rxt(k,699) + rxt(k,707) + rxt(k,716)) * y(k,99)
         mat(k,1700) = -(rxt(k,624) + rxt(k,697) + rxt(k,710) + rxt(k,719)) * y(k,99)
         mat(k,1677) = -(rxt(k,631) + rxt(k,726) + rxt(k,730) + rxt(k,734)) * y(k,99)
         ...
         mat(k,1813) = -(rxt(k,266)*y(k,164) + rxt(k,267)*y(k,259) + (rxt(k,278) &
                      + rxt(k,279)) * y(k,255) + (rxt(k,625) + rxt(k,695) + rxt(k,706) &
                      + rxt(k,715)) * y(k,111) + (rxt(k,626) + rxt(k,696) + rxt(k,709) &
                      + rxt(k,718)) * y(k,110) + (rxt(k,630) + rxt(k,725) + rxt(k,729) &
         ...
         mat(k,1837) = -(rxt(k,625) + rxt(k,695) + rxt(k,706) + rxt(k,715)) * y(k,103)
         mat(k,1704) = -(rxt(k,626) + rxt(k,696) + rxt(k,709) + rxt(k,718)) * y(k,103)
         mat(k,1681) = -(rxt(k,630) + rxt(k,725) + rxt(k,729) + rxt(k,733)) * y(k,103)
         ...
         mat(k,1348) = -(rxt(k,307)*y(k,157) + rxt(k,335)*y(k,259) + (rxt(k,627) &
                      + rxt(k,700) + rxt(k,708) + rxt(k,717)) * y(k,111) + (rxt(k,628) &
                      + rxt(k,698) + rxt(k,711) + rxt(k,720)) * y(k,110) + (rxt(k,632) &
                      + rxt(k,727) + rxt(k,731) + rxt(k,735)) * y(k,112))
         mat(k,2801) = -rxt(k,307)*y(k,107)
         mat(k,2166) = -rxt(k,335)*y(k,107)
         mat(k,1832) = -(rxt(k,627) + rxt(k,700) + rxt(k,708) + rxt(k,717)) * y(k,107)
         mat(k,1699) = -(rxt(k,628) + rxt(k,698) + rxt(k,711) + rxt(k,720)) * y(k,107)
         mat(k,1676) = -(rxt(k,632) + rxt(k,727) + rxt(k,731) + rxt(k,735)) * y(k,107)
         ...
         mat(k,1703) = -(rxt(k,301)*y(k,164) + (rxt(k,624) + rxt(k,697) + rxt(k,710) &
                      + rxt(k,719)) * y(k,99) + (rxt(k,626) + rxt(k,696) + rxt(k,709) &
                      + rxt(k,718)) * y(k,103) + (rxt(k,628) + rxt(k,698) + rxt(k,711) &
                      + rxt(k,720)) * y(k,107))
         mat(k,2492) = -rxt(k,301)*y(k,110)
         mat(k,1599) = -(rxt(k,624) + rxt(k,697) + rxt(k,710) + rxt(k,719)) * y(k,110)
         mat(k,1812) = -(rxt(k,626) + rxt(k,696) + rxt(k,709) + rxt(k,718)) * y(k,110)
         mat(k,1351) = -(rxt(k,628) + rxt(k,698) + rxt(k,711) + rxt(k,720)) * y(k,110)
...
!----------------------------------------------
      do k = 1,avec_len
         mat(k,1838) = -(rxt(k,268)*y(k,72) + rxt(k,269)*y(k,164) + rxt(k,270) &
                      *y(k,259) + (rxt(k,623) + rxt(k,699) + rxt(k,707) + rxt(k,716) &
                      ) * y(k,99) + (rxt(k,625) + rxt(k,695) + rxt(k,706) + rxt(k,715) &
                      ) * y(k,103) + (rxt(k,627) + rxt(k,700) + rxt(k,708) + rxt(k,717) &
                      ) * y(k,107))
         mat(k,2275) = -rxt(k,268)*y(k,111)
         mat(k,2496) = -rxt(k,269)*y(k,111)
         mat(k,2188) = -rxt(k,270)*y(k,111)
         mat(k,1600) = -(rxt(k,623) + rxt(k,699) + rxt(k,707) + rxt(k,716)) * y(k,111)
         mat(k,1814) = -(rxt(k,625) + rxt(k,695) + rxt(k,706) + rxt(k,715)) * y(k,111)
         mat(k,1352) = -(rxt(k,627) + rxt(k,700) + rxt(k,708) + rxt(k,717)) * y(k,111)
         ...
         mat(k,1679) = -(rxt(k,308)*y(k,259) + rxt(k,337)*y(k,157) + (rxt(k,630) &
                      + rxt(k,725) + rxt(k,729) + rxt(k,733)) * y(k,103) + (rxt(k,631) &
                      + rxt(k,726) + rxt(k,730) + rxt(k,734)) * y(k,99) + (rxt(k,632) &
                      + rxt(k,727) + rxt(k,731) + rxt(k,735)) * y(k,107))
         mat(k,2183) = -rxt(k,308)*y(k,112)
         mat(k,2816) = -rxt(k,337)*y(k,112)
         mat(k,1811) = -(rxt(k,630) + rxt(k,725) + rxt(k,729) + rxt(k,733)) * y(k,112)
         mat(k,1598) = -(rxt(k,631) + rxt(k,726) + rxt(k,730) + rxt(k,734)) * y(k,112)
         mat(k,1350) = -(rxt(k,632) + rxt(k,727) + rxt(k,731) + rxt(k,735)) * y(k,112)
         ...
         mat(k,1349) = (rxt(k,632)+rxt(k,727)+rxt(k,731)+rxt(k,735))*y(k,112)
         mat(k,1678) = (rxt(k,632)+rxt(k,727)+rxt(k,731)+rxt(k,735))*y(k,107)
         ...
         mat(k,1594) = (rxt(k,631)+rxt(k,726)+rxt(k,730)+rxt(k,734))*y(k,112)
         mat(k,1346) = (rxt(k,628)+rxt(k,698)+rxt(k,711)+rxt(k,720))*y(k,110)
         mat(k,1696) = (rxt(k,628)+rxt(k,698)+rxt(k,711)+rxt(k,720))*y(k,107)
         mat(k,1674) = (rxt(k,631)+rxt(k,726)+rxt(k,730)+rxt(k,734))*y(k,99)
         mat(k,1997) = rxt(k,327)*y(k,127)
         mat(k,1807) = (rxt(k,630)+rxt(k,725)+rxt(k,729)+rxt(k,733))*y(k,112)
         mat(k,1347) = (rxt(k,627)+rxt(k,700)+rxt(k,708)+rxt(k,717))*y(k,111)
         mat(k,1830) = (rxt(k,627)+rxt(k,700)+rxt(k,708)+rxt(k,717))*y(k,107)
         mat(k,1675) = (rxt(k,630)+rxt(k,725)+rxt(k,729)+rxt(k,733))*y(k,103)
...
!----------------------------------------------
      do k = 1,avec_len
         ...
         mat(k,110) = -(rxt(k,616)*y(k,259))
         mat(k,2039) = -rxt(k,616)*y(k,151)
...
!----------------------------------------------
      do k = 1,avec_len
         ...
         mat(k,2193) = -(rxt(k,209)*y(k,95) + rxt(k,210)*y(k,97) + rxt(k,211)*y(k,237) &
                      ...
                      *y(k,184) + rxt(k,608)*y(k,181) + rxt(k,613)*y(k,183) + rxt(k,616) &
                      *y(k,151))
...
!----------------------------------------------
      do k = 1,avec_len
         ...
         mat(k,1609) = (rxt(k,624)+rxt(k,697)+rxt(k,710)+rxt(k,719))*y(k,110) + ( &
         ...
         mat(k,1828) = (rxt(k,626)+rxt(k,696)+rxt(k,709)+rxt(k,718))*y(k,110) + ( &
                      + rxt(k,625)+rxt(k,695)+rxt(k,706)+rxt(k,715))*y(k,111) + ( &
                      + rxt(k,630)+rxt(k,725)+rxt(k,729)+rxt(k,733))*y(k,112) &
                      + rxt(k,267)*y(k,259)
         mat(k,1032) = rxt(k,400)*y(k,259)
         mat(k,1360) = (rxt(k,628)+rxt(k,698)+rxt(k,711)+rxt(k,720))*y(k,110) + ( &
         ...
         mat(k,1718) = (rxt(k,624)+rxt(k,697)+rxt(k,710)+rxt(k,719))*y(k,99) + ( &
                      + rxt(k,626)+rxt(k,696)+rxt(k,709)+rxt(k,718))*y(k,103) + ( &
                      + rxt(k,628)+rxt(k,698)+rxt(k,711)+rxt(k,720))*y(k,107)
         mat(k,1852) = (rxt(k,623)+rxt(k,699)+rxt(k,707)+rxt(k,716))*y(k,99) + ( &
                      + rxt(k,625)+rxt(k,695)+rxt(k,706)+rxt(k,715))*y(k,103) + ( &
                      + rxt(k,627)+rxt(k,700)+rxt(k,708)+rxt(k,717))*y(k,107) &
                      + rxt(k,270)*y(k,259)
         mat(k,1695) = (rxt(k,631)+rxt(k,726)+rxt(k,730)+rxt(k,734))*y(k,99) + ( &
         ...
         mat(k,2206) = rxt(k,355)*y(k,31) + rxt(k,420)*y(k,34) + rxt(k,445)*y(k,36) &
                      ...
                      *y(k,108) + rxt(k,217)*y(k,109) + rxt(k,270)*y(k,111) &
                      + rxt(k,308)*y(k,112) + .500_r8*rxt(k,472)*y(k,136) + rxt(k,616) &
