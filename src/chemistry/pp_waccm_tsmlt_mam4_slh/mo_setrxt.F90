...
!-------------------------------------------------------
      ...
      rate(:,666) = 1.2e-14_r8
      rate(:,667) = 2e-10_r8
      rate(:,672) = 1.34e-11_r8
      rate(:,676) = 1.34e-11_r8
      rate(:,679) = 1.7e-11_r8
      rate(:,725) = 6e-11_r8
      rate(:,728) = 1e-12_r8
      rate(:,729) = 4e-10_r8
      ...
      rate(:,733) = 4.4e-10_r8
      rate(:,734) = 9e-10_r8
      rate(:,737) = 1.29e-07_r8
      rate(:,738) = 2.31e-07_r8
      rate(:,739) = 2.31e-06_r8
      rate(:,740) = 4.63e-07_r8
      ...
      rate(:,666) = 1.2e-14_r8 * exp_fac(:)
      rate(:,667) = 2e-10_r8 * exp_fac(:)
      rate(:,672) = 1.34e-11_r8 * exp_fac(:)
      rate(:,676) = 1.34e-11_r8 * exp_fac(:)
      rate(:,679) = 1.7e-11_r8 * exp_fac(:)
      rate(:,725) = 6e-11_r8 * exp_fac(:)
      rate(:,728) = 1e-12_r8 * exp_fac(:)
      rate(:,729) = 4e-10_r8 * exp_fac(:)
      rate(:,730) = 2e-10_r8 * exp_fac(:)
      rate(:,731) = 1e-10_r8 * exp_fac(:)
      rate(:,732) = 5e-16_r8 * exp_fac(:)
      rate(:,733) = 4.4e-10_r8 * exp_fac(:)
      rate(:,734) = 9e-10_r8 * exp_fac(:)
      rate(:,737) = 1.29e-07_r8 * exp_fac(:)
      rate(:,738) = 2.31e-07_r8 * exp_fac(:)
      rate(:,739) = 2.31e-06_r8 * exp_fac(:)
      rate(:,740) = 4.63e-07_r8 * exp_fac(:)
      ...
      rate(:,422) = 4.63e-12_r8 * exp( 350._r8 * itemp(:) )
      ...
      rate(:,443) = 1.41e-13_r8 * exp( 1300._r8 * itemp(:) )
