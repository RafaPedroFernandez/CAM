...
!--------------------------------------------------------------------
      if( class == 1 ) then
         prod(:,1) =rxt(:,613)*y(:,282)*y(:,150) +rxt(:,623)*y(:,151)
         prod(:,2) = (rxt(:,525)*y(:,263) +rxt(:,528)*y(:,275) +rxt(:,531)*y(:,277) + &
                 rxt(:,535)*y(:,172))*y(:,155) +.500_r8*rxt(:,464)*y(:,282)*y(:,139) &
                  +.200_r8*rxt(:,560)*y(:,280)*y(:,154) +.500_r8*rxt(:,572)*y(:,241) &
                 *y(:,156)
!--------------------------------------------------------------------
