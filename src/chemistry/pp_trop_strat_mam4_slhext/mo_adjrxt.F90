...
!--------------------------------------------------------------------
      ...
      rate(:,:, 175) = rate(:,:, 175) * inv(:,:, 2)
      rate(:,:, 176) = rate(:,:, 176) * inv(:,:, 3)
      rate(:,:, 180) = rate(:,:, 180) * inv(:,:, 1)
      rate(:,:, 197) = rate(:,:, 197) * inv(:,:, 1)
      rate(:,:, 204) = rate(:,:, 204) * inv(:,:, 3)
      ...
      rate(:,:, 525) = rate(:,:, 525) * inv(:,:, 1)
      rate(:,:, 528) = rate(:,:, 528) * inv(:,:, 1)
      rate(:,:, 531) = rate(:,:, 531) * inv(:,:, 1)
      rate(:,:, 538) = rate(:,:, 538) * inv(:,:, 1)
      rate(:,:, 543) = rate(:,:, 543) * inv(:,:, 1)
      rate(:,:, 583) = rate(:,:, 583) * inv(:,:, 3)
      rate(:,:, 584) = rate(:,:, 584) * inv(:,:, 1)
      rate(:,:, 590) = rate(:,:, 590) * inv(:,:, 3)
      rate(:,:, 181) = rate(:,:, 181) * inv(:,:, 3) * inv(:,:, 1)
