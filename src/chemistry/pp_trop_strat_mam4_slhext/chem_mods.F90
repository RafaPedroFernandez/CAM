...
!--------------------------------------------------------------
      ...
      implicit none
      save
      integer, parameter :: phtcnt = 172, & ! number of photolysis reactions
                            rxntot = 707, & ! number of total reactions
                            gascnt = 535, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 294, & ! number of "gas phase" species
                            nfs = 3, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 2714, & ! number of non-zero matrix entries
                            ...
                            clscnt4 = 292, & ! number of species in implicit class
