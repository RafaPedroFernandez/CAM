...
!--------------------------------------------------------------------
      if( class == 1 ) then
         prod(:,1) =rxt(:,593)*y(:,248)*y(:,149) +rxt(:,603)*y(:,150)
         prod(:,2) = (rxt(:,505)*y(:,229) +rxt(:,508)*y(:,241) +rxt(:,511)*y(:,243) + &
                 rxt(:,515)*y(:,171))*y(:,154) +.500_r8*rxt(:,444)*y(:,248)*y(:,138) &
                  +.200_r8*rxt(:,540)*y(:,246)*y(:,153) +.500_r8*rxt(:,552)*y(:,207) &
                 *y(:,155)
!--------------------------------------------------------------------
