...
!--------------------------------------------------------------------
      ...
      rate(:,:, 505) = rate(:,:, 505) * inv(:,:, 1)
      rate(:,:, 508) = rate(:,:, 508) * inv(:,:, 1)
      rate(:,:, 511) = rate(:,:, 511) * inv(:,:, 1)
      rate(:,:, 518) = rate(:,:, 518) * inv(:,:, 1)
      rate(:,:, 523) = rate(:,:, 523) * inv(:,:, 1)
      rate(:,:, 563) = rate(:,:, 563) * inv(:,:, 3)
      rate(:,:, 564) = rate(:,:, 564) * inv(:,:, 1)
      rate(:,:, 570) = rate(:,:, 570) * inv(:,:, 3)
