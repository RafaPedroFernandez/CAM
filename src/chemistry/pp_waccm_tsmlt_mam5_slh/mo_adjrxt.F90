...
!--------------------------------------------------------------------
      ...
      rate(:,:, 492) = rate(:,:, 492) * inv(:,:, 1)
      rate(:,:, 549) = rate(:,:, 549) * inv(:,:, 1)
      rate(:,:, 552) = rate(:,:, 552) * inv(:,:, 1)
      rate(:,:, 555) = rate(:,:, 555) * inv(:,:, 1)
      rate(:,:, 562) = rate(:,:, 562) * inv(:,:, 1)
      rate(:,:, 567) = rate(:,:, 567) * inv(:,:, 1)
      rate(:,:, 608) = rate(:,:, 608) * inv(:,:, 1)
      rate(:,:, 750) = rate(:,:, 750) * inv(:,:, 2)
      rate(:,:, 753) = rate(:,:, 753) * inv(:,:, 2)
      rate(:,:, 182) = rate(:,:, 182) * m(:,:)
      rate(:,:, 183) = rate(:,:, 183) * m(:,:)
      rate(:,:, 185) = rate(:,:, 185) * m(:,:)
      rate(:,:, 186) = rate(:,:, 186) * m(:,:)
