...
!--------------------------------------------------------------------
      ...
      rate(:,:, 156) = rate(:,:, 156) * inv(:,:, 3)
      rate(:,:, 160) = rate(:,:, 160) * inv(:,:, 1)
      rate(:,:, 177) = rate(:,:, 177) * inv(:,:, 1)
      rate(:,:, 184) = rate(:,:, 184) * inv(:,:, 3)
      ...
      rate(:,:, 509) = rate(:,:, 509) * inv(:,:, 1)
      rate(:,:, 512) = rate(:,:, 512) * inv(:,:, 1)
      rate(:,:, 515) = rate(:,:, 515) * inv(:,:, 1)
      rate(:,:, 522) = rate(:,:, 522) * inv(:,:, 1)
      rate(:,:, 527) = rate(:,:, 527) * inv(:,:, 1)
      rate(:,:, 567) = rate(:,:, 567) * inv(:,:, 3)
      rate(:,:, 568) = rate(:,:, 568) * inv(:,:, 1)
      rate(:,:, 574) = rate(:,:, 574) * inv(:,:, 3)
      rate(:,:, 161) = rate(:,:, 161) * inv(:,:, 3) * inv(:,:, 1)
