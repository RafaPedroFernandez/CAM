...
!--------------------------------------------------------------------
      if( class == 1 ) then
         prod(:,1) =rxt(:,597)*y(:,254)*y(:,153) +rxt(:,607)*y(:,154)
         prod(:,2) = (rxt(:,509)*y(:,235) +rxt(:,512)*y(:,247) +rxt(:,515)*y(:,249) + &
                 rxt(:,519)*y(:,176))*y(:,158) +.500_r8*rxt(:,448)*y(:,254)*y(:,142) &
                  +.200_r8*rxt(:,544)*y(:,252)*y(:,157) +.500_r8*rxt(:,556)*y(:,213) &
                 *y(:,159)
!--------------------------------------------------------------------
